              ...
              <div className="mb-4 p-3 bg-gray-100 rounded">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-gray-500 bg-white px-2 py-1 rounded">
                    {data.filename?.toLowerCase().includes('.pdf') ? 'PDF File' : 
                     data.filename?.toLowerCase().includes('.jpg') || data.filename?.toLowerCase().includes('.jpeg') ? 'JPEG Image' :
                     data.filename?.toLowerCase().includes('.png') ? 'PNG Image' : 'Image File'}
                  </span>
                </div>
                <div className="mt-2 flex items-center justify-between">
                  ...
                  {data.records && data.records.length > 1 && (
                    <div className="text-xs text-blue-600 font-medium">
                      {data.records.length} records found
                    </div>
                  )}
                </div>
                {data.records && data.records.length > 1 && (
